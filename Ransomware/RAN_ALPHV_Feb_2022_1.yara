rule RAN_ALPHV_Feb_2022_1 : alphav blackcat ransomware
{
    ...
    strings:
        ...
        $s2 = { 53 57 56 e8 [3] 00 83 c4 0c 8d 04 1e 8d 4d dc 89 f2 6a 00 50 e8 [3] 00 83 c4 08 8b 45 e4 f2 0f 10 45 dc 8d 4d d0 89 45 d8 f2 0f 11 45 d0 e8 ?? ?? fe ff 89 c7 85 db 89 55 f0 74 0e 56 6a 00 ff 35 [3] 00 e8 [3] 00 6a 2c 57 8b 45 e8 ff 30 e8 [3] 00 85 c0 74 28 8b 55 08 f7 45 f0 ff ff ff 7f 8b 75 ec 8b 4a 08 f2 0f 10 02 89 4e 08 f2 0f 11 06 89 46 0c 66 c7 07 00 00 74 40 57 eb 30 8b 45 ec f7 45 f0 ff ff ff 7f c7 00 00 00 00 00 66 c7 07 00 00 74 0e 57 6a 00 }

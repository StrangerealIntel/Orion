rule RAN_Hive_March_2021_1 : hive v5 x64
{
   meta:
        ...
        date = "2021-03-26"
        hash1 = "1841ca56006417e6220a857f66c8e6539502d5e9f539cf337b83a25c15d17a50"
        hash2 = "efdbfcb717b109b816e2d2f99c0d923803c70dd08fb9feb747eb90774e86116e"
        tlp = "white"
        adversary = "Hive"
   strings:
        ...
        $s4 = { 48 8d 6c 24 40 48 89 45 00 48 89 55 08 66 c7 45 10 00 00 c7 45 18 01 00 00 00 ?? 8d ?? 24 [2-5] 89 ?? 48 89 ea e8 [3] 00 ?? 8b ?? 48 89 7c 24 30 ?? 89 ?? 24 28 4c 89 64 24 20 48 89 f1 31 d2 4d 89 f0 41 b9 ff ff ff ff e8 }
   condition:

rule TA_Lorec53_OutSteel_Feb_2022_1
{
   meta:
        ...
        hash5 = "320d091b3f8de8688ce3b45cdda64a451ea6c22da1fcea60fe31101eb6f0f6c2"
        tlp = "White"
        adversary = "Lorec53"
   strings:
        ...
        $s6 = { 1C ?? 8A FF 5E ?? 88 42 0B E5 3D 48 F0 B0 7B DA 58 FF C0 E3 B0 B0 0B 01 [3] 00 [3] 00 [7] 01 [7] 01 [4] 6D FB FA 03 B3 }
    condition:
